      ...
      <div className="container py-12 max-w-5xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            How Fantasy Cricket Works on RosterMind
          </h1>
        ...
        <div className="space-y-12">
          ...
          <Card>
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                On RosterMind, this entire experience is <strong>completely free and strategy-based</strong>. No payments. No luck. No financial risk — just pure cricketing decisions and skill-driven results.
              </p>
            </CardContent>
          </Card>

          {/* How RosterMind Works */}
          <Card>
            <CardContent className="p-8 space-y-4">
              <h2 className="text-2xl font-bold flex items-center gap-3">
                <BarChart3 className="h-8 w-8 text-primary" />
                ⚙️ How Does RosterMind Fantasy Work?
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                RosterMind Fantasy Sports is a web-based platform where your cricket expertise drives everything. There are no payments, no premium upgrades, and no chance-based elements. All features are free and accessible from the moment you join.
              </p>
              <ol className="space-y-3 text-muted-foreground pl-6">
                <li className="leading-relaxed">
                  <strong>1. Pick a Match:</strong> Choose from upcoming or live cricket fixtures available on RosterMind.
                </li>
                <li className="leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                At RosterMind, your only investment is your time and cricketing skill — not money.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                RosterMind Fantasy Sports is built entirely on skill. Every point you earn is the result of your decisions — from team selection to captaincy choices. There are no random outcomes, no hidden mechanics, and no optional boosts.
              </p>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                There are no shortcuts or random wins. Just smart decisions, strategic planning, and your cricket expertise — that's what drives success on RosterMind.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                On RosterMind Fantasy Sports, your score is driven entirely by the real-world match performance of your selected players. Our scoring system is fully transparent — no hidden rules, no random bonuses, and no unpredictable outcomes.
              </p>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Success on RosterMind depends on one thing: your ability to read the match, analyze form, and choose the right players at the right time.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                On RosterMind, your rank on the leaderboard reflects one thing: your cricketing intelligence. We don't offer cash rewards, paid upgrades, or shortcut advantages. What matters here is your ability to study the game and make informed decisions — just like a real coach or selector would.
              </p>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your skill, strategy, and timing determine your place on the leaderboard — not your wallet. That's what makes RosterMind different from every other fantasy platform.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-8 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                RosterMind Fantasy Sports is a skill-first platform — not a game of chance, not a money-driven app, and not a rewards-based competition. Every user plays on the exact same terms, with no paid advantages or hidden mechanics.
              </p>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <ul className="space-y-3 text-muted-foreground pl-6">
                ...
                <li className="leading-relaxed">
                  🚫 <strong>No Credit, Coins, or Refunds:</strong> RosterMind is always free. If a match is canceled, your entry simply resets — no fake currency involved.
                </li>
                <li className="leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Fairness isn't just a policy — it's part of the game design. RosterMind was built to let true cricket fans enjoy fantasy sports without money, manipulation, or pressure.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Join RosterMind today and experience fantasy cricket the way it should be — free, fair, and skill-based.
            </p>
          </div>
        </div>
      </div>
